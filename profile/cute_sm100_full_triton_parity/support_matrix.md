...
| `stochastic_unbiased` | `True` | NVFP4/IF4/IF4_BS8; NVFP4 pseudo via quantize+dequantize; static `nvfp4_bs8`, `mxfp3`, `mxfp3_bs8`, `mxfp4`, `mxfp4_bs8`, `mxfp6_*`, `nvfp3`, `nvfp3_bs8`, `nvint3`, `nvint3_bs8`, `nvint4`, `nvint4_bs8`, and 1D `nvfp6_e3m2`; 2D NVFP4/IF4 and static `nvfp4_bs8`/`mxfp3`/`mxfp3_bs8`/`mxfp4`/`mxfp4_bs8`/`nvfp3`/`nvfp3_bs8`/`nvint3`/`nvint3_bs8`/`nvint4`/`nvint6`/NVFP6 |
