        ...
        for scale_rule in sorted(dtype.supported_scale_rules, key=lambda rule: rule.value):
            for feature_kwargs in FEATURES:
                ...
                for round_style in ROUND_STYLES:
                    ...
                    cute_predicate_count += int(predicates[QuantizeBackend.cute_sm120])
                    ...
                    cute_runs, cute_error = _runnable(
                        x,
                        QuantizeBackend.cute_sm120,
                        configs[QuantizeBackend.cute_sm120],
                    )
                    ...
                    if triton_runs and not predicates[QuantizeBackend.cute_sm120]:
                        cute_missing_runnable.append(row)
                    if predicates[QuantizeBackend.cute_sm120] and not cute_runs:
